...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agents", "Show active agents and running tasks", "Session",
               aliases=("tasks",)),
    CommandDef("queue", "Queue, list, pop, or clear follow-up prompts (doesn't interrupt)", "Session",
               aliases=("q",), args_hint="[list|pop|clear|<prompt>]"),
    ...
    CommandDef("cost", "Toggle session cost display in the status bar", "Configuration",
               cli_only=True, args_hint="[on|off|toggle|status]",
               subcommands=("on", "off", "toggle", "status")),
    CommandDef("tps", "Toggle tokens-per-second display in the status bar", "Configuration",
               cli_only=True, args_hint="[on|off|toggle|status]",
               subcommands=("on", "off", "toggle", "status")),
    CommandDef("timer-emoji", "Toggle stopwatch emoji on per-prompt timer in status bar", "Configuration",
               cli_only=True, args_hint="[on|off|toggle|status]",
               subcommands=("on", "off", "toggle", "status")),
