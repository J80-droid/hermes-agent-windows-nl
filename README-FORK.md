...
- **Drift catch-up:** `windows\SYNC_NOUS_DRIFT_CATCHUP.bat` — SSOT [`docs/NOUS_DRIFT_MAINTENANCE.md`](docs/NOUS_DRIFT_MAINTENANCE.md).
- **Nous-merge:** `windows\SYNC_NOUS.bat` (geen `-Yes` voor routine drift).
...
Zie [`docs/NOUS_OVERLAY_ARCHITECTURE.md`](docs/NOUS_OVERLAY_ARCHITECTURE.md), [`docs/NOUS_DRIFT_MAINTENANCE.md`](docs/NOUS_DRIFT_MAINTENANCE.md), [`docs/NOUS_DRIFT_BASELINE.md`](docs/NOUS_DRIFT_BASELINE.md).
