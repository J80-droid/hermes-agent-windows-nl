...
function Get-HermesRepoRootAllowlist {
    return @(
        '.gitignore', '.gitattributes', '.dockerignore', '.cursorrules', '.env', '.pre-commit-config.yaml', 'pyproject.toml', 'package.json', 'package-lock.json',
        'cli-config.yaml.example',
        'uv.lock', 'README.md', 'README-FORK.md', 'README.zh-CN.md',
        'AGENTS.md', 'cli.py', 'hermes_cli_entry.py', 'hermes', 'setup-hermes.sh',
        'run_agent.py', 'model_tools.py', 'toolsets.py',
        'hermes_state.py', 'hermes_constants.py', 'hermes_logging.py',
        'hermes_bootstrap.py', 'hermes_time.py', 'batch_runner.py',
        'trajectory_compressor.py', 'toolset_distributions.py', 'utils.py', 'mcp_serve.py',
        'config.yaml',
        'start_hermes.bat',
