...
cd /d "%~dp0.."
powershell -NoProfile -ExecutionPolicy Bypass -Command ". '%~dp0HermesShellCommon.ps1'; [void](Invoke-HermesEnableConsoleAnsi); Reset-HermesConsoleInputModes; Invoke-HermesDisableConsoleQuickEdit; try { Clear-Host } catch { }; Reset-HermesConsoleInputModes" 2>nul
cls >nul 2>&1
