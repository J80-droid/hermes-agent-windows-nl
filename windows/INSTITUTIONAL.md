...
| Script | Doel |
| ------ | ---- |
| `windows\scripts\institutional_p0_p1.bat` | Sync MCP → `doctor --fix` → MCP-test → legal rooktest (`call hermes_legal_rooktest.bat "%HERMES_REPO%" "%PY%"` — setlocal-safe; wiring-E2E: `audits\RUN_INSTITUTIONAL_P0P1_WIRING_E2E.bat`) |
