...
$analystTpl = Join-HermesRepoPath -RepoRoot $RepoRoot -RelativePath 'docs/templates/SOUL_ANALYST_DOMAIN.md'
...
$legalTpl = Join-HermesRepoPath -RepoRoot $RepoRoot -RelativePath 'docs/templates/SOUL_LEGAL_DOMAIN.md'
