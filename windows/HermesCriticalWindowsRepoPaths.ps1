...
function Get-HermesCriticalWindowsRepoPathList {
    ...
    'overlay/hermes_cli/institutional_new_chat_notice.py',
    'overlay/ui-tui/src/lib/newChatNotice.ts',
    'overlay/ui-tui/src/app/useInstitutionalNewChatAutoReset.ts',
    ...
    'overlay/hermes_cli/cli_profile_fork_patch.py',
    'overlay/hermes_cli/config_fork_patch.py',
    'overlay/hermes_cli/doctor_fork_patch.py',
    'overlay/hermes_cli/tools_config_fork_patch.py',
    'overlay/agent/prompt_builder_fork_patch.py',
    'overlay/agent/prompt_builder_legal.py',
    'overlay/ui-tui/src/app/gatewayReadyNewChatNotice.ts',
    ...
    'audits/NousOverlayInstitutionalE2E.harness.py',
    'audits/NousOverlayInstitutionalE2E.core.ps1',
    'audits/RUN_NOUS_OVERLAY_INSTITUTIONAL_E2E.bat',
    'audits/NousOverlayRuntimeE2E.harness.py',
    'audits/NousOverlayRuntimeE2E.core.ps1',
    'audits/RUN_NOUS_OVERLAY_RUNTIME_E2E.bat',
    'audits/NousOverlayForkGatesE2E.harness.py',
    'audits/NousOverlayForkGatesE2E.core.ps1',
    'audits/RUN_NOUS_OVERLAY_FORK_GATES_E2E.bat',
    'tests/audits/test_nous_overlay_fork_gates_e2e_harness.py',
    ...
    'tests/overlay/test_bootstrap.py',
    'tests/overlay/test_cli_fork_patch.py',
    'tests/overlay/test_agent_throughput_fork_patch.py',
    'docs/NOUS_OVERLAY_ARCHITECTURE.md',
    'docs/NOUS_DRIFT_MAINTENANCE.md',
    ...
    'windows/audits/RUN_PRODUCTION_GATE.ps1',
    'windows/audits/RUN_PRODUCTION_GATE.bat',
    'windows/tests/RUN_PYTEST_FORK_GATE.ps1',
    'windows/tests/RUN_PYTEST_FORK_GATE.bat',
    'windows/tests/RUN_PYTEST_UPSTREAM.ps1',
    'windows/tests/RUN_PYTEST_UPSTREAM.bat',
    'windows/tests/pytest_fork_gate.yaml',
    'windows/tests/PYTEST_POLICY.md',
    ...
    'audits/RUN_PYTEST_RUNNER_HARDENING_E2E.bat',
    'audits/PytestRunnerHardeningE2E.harness.py',
    'audits/PytestRunnerHardeningE2E.core.ps1',
    'audits/_PytestRunnerHardeningE2E_argcheck.ps1',
    'windows/tests/HermesPytestFromManifest.Unit.Tests.ps1',
    ...
    'overlay/hermes_cli/legal_architecture_brief.py',
    ...
    'audits/LegalMemoryLanguageLayersE2E.harness.py',
    'audits/LegalMemoryLanguageLayersE2E.core.ps1',
    'audits/RUN_LEGAL_MEMORY_LANGUAGE_LAYERS_E2E.bat',
    'audits/LEGAL_MEMORY_LANGUAGE_LAYERS_E2E_README.md',
    'tests/audits/test_legal_memory_language_layers_e2e_harness.py',
