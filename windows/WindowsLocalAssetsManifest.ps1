...
function Get-HermesWindowsLocalAssetsManifest {
    $winFiles = @(
        ...
        'POST_GIT_PULL.bat',
        'INVENTORY_HERMES_HOME.bat',
        'VERIFY_HERMES_CONFIG_DRIFT.bat',
        'DEPRECATE_LEGACY_CONFIG.bat',
        'APPLY_AUXILIARY_HYBRID_PRESET.bat',
        'APPLY_HERMES_HOME_MIGRATION.bat',
        'apply_hermes_home_migration.ps1',
        'VERIFY_GATEWAY_HOME.bat',
        'REPAIR_GATEWAY_HOME.bat',
    ...
    $scriptsFiles = @(
        ...
        'inventory_hermes_home.ps1',
        'verify_hermes_config_drift.ps1',
        'deprecate_legacy_config.ps1',
        'merge_legacy_auxiliary_config.py',
        'apply_auxiliary_hybrid_preset.ps1',
        'apply_auxiliary_hybrid_preset.py',
        'ensure_hermes_launch_env.ps1',
        'verify_gateway_home.ps1',
        'repair_gateway_home.ps1',
        'sync_soul_config_governance_snippet.ps1',
