...
| 2 | `pytest -m integration` (timeout 600s; live `BatchRunner`-tests alleen met `HERMES_RUN_LIVE_BATCH=1`, anders skip — gebruikt actieve provider uit config, geen hardcoded OpenRouter) | `FULL_VERIFY_integration.log` |
