...
def render_report(data: dict) -> str:
    ...
    lines = [
        ...
        f"| E3 (CI-pariteit) | {'Ja' if release else 'Nee'} | {'Ja' if release else 'Nee'} | RUN_PYTEST.ps1 / run_tests.sh / RUN_AUDITS -IncludeAllE2E |",
        "",
    ...
    lines.extend(
        [
            ...
            "### Niet in scope",
            "",
            "- Volledige E3 testsuite (~17k tests) tenzij release-gate expliciet gedraaid [E3].",
