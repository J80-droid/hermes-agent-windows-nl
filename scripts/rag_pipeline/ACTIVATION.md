...
| Twee config-paden | Windows fork: canoniek `%LOCALAPPDATA%\hermes\config.yaml`; legacy stub `~/.hermes/config.yaml` → `docs/HERMES_HOME_WINDOWS.md`, `VERIFY_HERMES_CONFIG_DRIFT.bat` |
