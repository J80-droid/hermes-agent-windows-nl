...
**Domein-toolsets mcp+kanban (2026-06-01):** alle profielen in `domain_toolsets.yaml` met `mcp`+`kanban` standaard; checklist via `CONFIGURABLE_TOOLSETS` (`hermes tools`); sync `SYNC_DOMAIN_TOOLSETS.bat`.
