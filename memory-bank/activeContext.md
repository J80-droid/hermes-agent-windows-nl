...
**Launch UI Sink (2026-05-29):** `HermesLaunchUi.ps1` + `launch_hermes.ps1` als PS-entry; enkelvoudige console-schrijver (EL `[2K`), capture naar log, rich visual in WT; bootstrap via orchestrator (geen `-SkipBootstrap` in bat); E2E **8/8** `audits/RUN_LAUNCH_UI_SINK_E2E.bat`; zie `windows/TERMINAL_WINDOWS.md`.
