...
- [x] Klassieke CLI statusbalk-kosten: `hermes_cli/status_bar_cost.py`, hooks in `cli.py`, `/cost` slash; pytest + verify drift-guard; E2E `RUN_CLASSIC_CLI_STATUS_BAR_COST_E2E.bat`
