...
- [x] Memory-trust integratie (2026-05-25): `RUN_MEMORY_TRUST_INTEGRATION_E2E` 8/8; unit `TrustRuntimePending` + `Invoke-MemoryTrustPostSync`; PSES workspace analyse uit; `Invoke-GitCommand` EAP-restore via `finally`
