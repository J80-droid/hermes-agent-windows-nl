...
- **TUI/CLI markdown:** Laag B = `institutional_render.py` + `display_markdown.py` (`get_assistant_console_theme`, demo-palet); Laag C UI = skin `default` via `skin_markdown_theme()`; gateway `agent/rich_output.py`
