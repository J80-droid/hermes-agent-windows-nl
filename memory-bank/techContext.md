...
- **Klassieke CLI statusbalk-kosten:** `hermes_cli/status_bar_cost.py` (Python formatter mirror), `cli.py` hooks (`_append_status_bar_cost_fragments`, `/cost`); zelfde snapshot + tiers; E2E `windows/audits/RUN_CLASSIC_CLI_STATUS_BAR_COST_E2E.bat`
