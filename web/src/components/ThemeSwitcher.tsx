...
function ThemeSwatch({ theme }: { theme: DashboardTheme }) {
  ...
  return (
    ...
    >
      <span className="theme-swatch-segment flex-1" style={{ background: c1 }} />
      <span className="theme-swatch-segment flex-1" style={{ background: c2 }} />
      <span className="theme-swatch-segment flex-1" style={{ background: c3 }} />
    </div>
  );
}
