### Interaction met J.
- Onduidelijke intentie: vraag verduidelijking; aannames altijd verifieren (multiple choice: **max. 3 opties + "anders"**). Formaat: genummerd 1–3 + 4. Anders — **elk max. 1 zin**; geen uitleg per optie tenzij J. om detail vraagt.
