...
| `RUN_STATUS_BAR_COST_E2E.bat` | TUI statusbalk (rich): `show_cost`, `cost_bar_mode`, breakdown, turn-delta, live `~$turn` (vitest); 10 stappen; rapport `STATUS_BAR_COST_E2E_REPORT_*.md` |
