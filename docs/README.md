...
- **Creative domein E2E:** `audits\RUN_CREATIVE_DOMAIN_E2E.bat` (11/11); unit `pytest tests/audits/test_creative_domain_e2e_harness.py -q` — zie [audits/CREATIVE_DOMAIN_E2E_README.md](../audits/CREATIVE_DOMAIN_E2E_README.md)
