...
| **Windows split-home (config, drift, migratie)** | [HERMES_HOME_WINDOWS.md](HERMES_HOME_WINDOWS.md) · E2E: `windows/audits/RUN_HERMES_HOME_E2E.bat` · eenmalig: `windows/APPLY_HERMES_HOME_MIGRATION.bat` |
