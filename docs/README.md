...
| Klassieke CLI prompt-wachtrij (`/queue`, hint, status) | [../windows/README.md](../windows/README.md) § `/queue` · E2E: `audits/RUN_CLI_PENDING_QUEUE_E2E.bat` · unit: `pytest tests/overlay/test_cli_pending_queue.py -q` |
...
| Pipeline hardening E2E (normalize → render → score) | `audits/RUN_INSTITUTIONAL_PIPELINE_E2E.bat` · [audits/INSTITUTIONAL_PIPELINE_E2E_README.md](../audits/INSTITUTIONAL_PIPELINE_E2E_README.md) · unit: `pytest tests/audits/test_institutional_pipeline_e2e_harness.py tests/overlay/test_institutional_render_helpers.py -q` |
