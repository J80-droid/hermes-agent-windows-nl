...
| TUI statusbalk-kosten (rich: turn/sessie, breakdown, tools) | `windows/audits/RUN_STATUS_BAR_COST_E2E.bat` — rapport `windows/audits/STATUS_BAR_COST_E2E_REPORT_2026-05-23.md` |
